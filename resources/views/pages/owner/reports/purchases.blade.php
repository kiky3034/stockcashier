<x-layouts.app :title="__('Purchase Report')">
    <div class="p-6 space-y-6">
        <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div class="flex flex-wrap gap-2">
                <button type="button"
                        ...
                        class="rounded-lg border border-slate-200 px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-sky-50">
                    Copy Summary
                </button>
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
            <form method="GET" action="{{ route('owner.reports.purchases') }}" class="grid gap-3 md:grid-cols-6">
                <input type="text"
                       ...
                       class="rounded-lg border-slate-200 text-sm focus:border-sky-400 focus:ring-sky-100">
        ...
        <div class="grid gap-4 md:grid-cols-3">
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                <div class="text-sm text-slate-500">Purchase Count</div>
                <div class="mt-2 text-xl font-bold text-slate-900">
        ...
        <div class="rounded-2xl border border-slate-200 bg-white shadow-sm">
            <div class="border-b border-slate-200 p-4">
                <h2 class="font-semibold text-slate-900">Top Purchased Products</h2>
            </div>
        ...
        <div class="rounded-2xl border border-slate-200 bg-white shadow-sm">
            <div class="border-b border-slate-200 p-4">
                <h2 class="font-semibold text-slate-900">Purchase List</h2>
            </div>
